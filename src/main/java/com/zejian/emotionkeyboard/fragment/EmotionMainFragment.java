...
public class EmotionMainFragment extends BaseFragment {
    ...
    private static EmotionShowInterface emotionShowInterface;

   public interface EmotionShowInterface{
         void setEmotionShow(Editable emotionShow);
    }

    public static void setEmotionShowInterface(EmotionShowInterface emotionInterface){
        emotionShowInterface = emotionInterface;
    ...
    protected void initListener(){
        ...
        bar_btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                emotionShowInterface.setEmotionShow(bar_edit_text.getText());
            }
        });
